...
const Hero = ({ myList, user }) => {
  ...
  return (
    <Container>
      ...
      />
      <Tags>
        <MenuTag>Action </MenuTag>
        <Separator />
        <MenuTag>TV Shows</MenuTag>
        <Separator />
        <MenuTag>Thriller</MenuTag>
      </Tags>
      <MenuHero>
        {user?.list.includes("K0VTUG7b4RmZHMEplkdW") ? (
          <Button
            activeOpacity={0.5}
            onPress={() => {
              db.collection("users")
                ...
                .collection("myList")
                .doc("K0VTUG7b4RmZHMEplkdW")
                .delete();

              var list = user.list;
              list.splice(list.indexOf("K0VTUG7b4RmZHMEplkdW"), 1);
          ...
          <Button
            ...
            onPress={() => {
              ...
              var list = user.list;
              list.push("K0VTUG7b4RmZHMEplkdW");
